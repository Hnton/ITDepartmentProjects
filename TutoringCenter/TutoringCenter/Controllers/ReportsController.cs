...
namespace TutoringCenter.Controllers
{
    public class ReportsController : Controller
    {
        ...
        public ActionResult Index()
        {
            return View(db.Reasons.ToList());//Will need to change this
        }
        ...
        public ActionResult Details(int? id)
        {
            ...
            Reason reason = db.Reasons.Find(id);//Probably this too
            if (reason == null)
            {
                return HttpNotFound();
            }
            return View(reason);//here
        }
